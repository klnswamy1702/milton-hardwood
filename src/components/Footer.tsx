        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-white/60 mb-6">
              {business.tagline}. Serving Milton, Ontario and the Greater
              Toronto Area with premium flooring products and expert
              installation.
            </p>
            {/* Social Links */}
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-5 font-sans">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/60">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${business.phone}`} className="hover:text-primary-light transition-colors">
                  {business.phone}
                </a>
              </li>
              <li className="flex items-center gap-3">
